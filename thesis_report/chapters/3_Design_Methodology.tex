...
On the receiver side, the \gls{dt} uses a \textbf{Zero-Order Hold (ZOH)} predictor: in the absence of a correction event, it assumes the last synchronized state remains valid,
\begin{equation}
