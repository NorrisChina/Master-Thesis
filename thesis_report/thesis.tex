...
% ===============================================
\input{tex_src/glossary_symbols}
\input{acronyms}
...
\printacronyms[style=acrotabularxpages,title={Acronyms}]
\endgroup
\clearpage

% Reset the first-use state after the acronym list so the main text
% (starting with the Introduction) expands acronyms on first occurrence.
\glsresetall
...
\include{chapters/3_Design_Methodology}
\include{chapters/4_Implementation}
\include{chapters/5_Results_and_Evaluation}
\include{chapters/6_Conclusion_and_Future_work}
